...
class Relawan_terverifikasi_model extends MY_Model{


  var $column_order = array(null, "tb_person.no_sk",'tb_person.nik',"struktur_pengurus.struktur_pengurus");
  var $column_search = array('tb_person.nik','tb_person.nama',"tb_person.telepon",'tb_person.email',"tb_person.id_kepengurusan","tb_person.id_jabatan","tb_person.wilayah_keanggotaan");
