			...
			<header class="header">
				<div class="logo-container">
					<a href="../2.2.0" class="logo">
						<img src="<?=base_url()?>_template/img/logo.png" width="75" height="35" alt="Porto Admin" />
					</a>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?=base_url()?>_template/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?=base_url()?>_template/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?=base_url()?>_template/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="<?=base_url()?>_template/img/!logged-user.jpg" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg" />
							</figure>
