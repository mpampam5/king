...
<section role="main" class="content-body">
		<header class="page-header">
			...
			<div class="right-wrapper text-right">
				<ol class="breadcrumbs">
					...
					<li><span>Upload Legalitas JPKP</span></li>
				</ol>
      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          <section class="card">
            <div class="card-body">
              <h5 class="card-title text-center">Upload Legalitas Lengkap JPKP</h5>
              <hr>
                <div class="text-center">
                      ...
                      <div id="act">
                        <?php if ($docs!=""): ?>
                          <a href="<?=site_url("backend/tentang/download")?>" class="btn btn-success btn-md mt-3" ><i class="fas fa-cloud-download-alt"></i> Download Berkas</a><br>
                          <a href="<?=site_url("backend/tentang/delete")?>" id="delete" class="btn btn-danger btn-md mt-3"><i class="fas fa-trash-alt"></i> Hapus Berkas</a>
                        <?php endif; ?>
                      </div>
                      <a href="<?=site_url("backend/tentang")?>" class="btn btn-default btn-md mt-3">Kembali</a>
                </div>
...
$(function () {
      ...
      fileupload.change(function () {
          ...
          $.ajax({
              url: '<?=site_url("backend/tentang/do_upload")?>',
              dataType: 'json',
              cache: false,
              contentType: false,
              processData: false,
