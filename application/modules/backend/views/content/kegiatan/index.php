...
<section role="main" class="content-body">
      ...
      <div class="row">
        <div class="col">
          <a href="<?=site_url("backend/kegiatan/add")?>" class="btn btn-sm btn-success mb-2"><i class="fas fa-plus"></i> Tambah</a>
          <section class="card">
            <div class="card-body">
...
$(document).ready(function(){
  var table = $('#table').dataTable({
    ...
    "ajax":
    {
      "url": "<?php echo site_url('backend/kegiatan/json') ?>", // URL file untuk proses select datanya
      "type": "POST"
    },
