...
{
  $this->template->set_title("Reset Password");
  $this->template->view("content/profile/form_reset_password");
}
...
function reset_password_action()
{
  if ($this->input->is_ajax_request()) {
      ...
      if ($this->form_validation->run()) {
        ...
        //logs Activity
        logs("administrator","reset_password",json_encode(["id_admin"=>sess("id_admin"),"keterangan"=>"mereset password akun"]));
