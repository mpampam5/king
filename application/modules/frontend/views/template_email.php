                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey mpampam5@gmail.com</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Silahkan Klik tombol di bawah untuk melakukan reset password.
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Peringatan! Pesan ini bersifat rahasia.</p>
                            </td>
                          </tr>
                        </table>
                      </td>
